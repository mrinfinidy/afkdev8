import { Badge, Heading, Link, SimpleGrid } from "@chakra-ui/react";
  ...
  return (
    <Layout title="">
      <Container4k>
        ...
        <P>
          I have recently tried out Stable Diffusion, a text-to-image deep
          learning model. This post contains various images that Stable
          Diffusion generated from my text and image inputs.
        </P>
        <br />
        ...
        <P>
          ...
          particularly surprising. The input is very standard and there are many
          similar AI generated pictures on the internet.
        </P>
        <P>
          Just out of curiosity I added the word &quot;slum&quot; and upscaled
          it to see what happens. This was the result.
        </P>
        <PostImage
        ...
        ></PostImage>
        <P>
          This one is quite funny, it probably made a meme because of the
          keyword &quot;parody&quot;. Although I have no idea what this meme
          could possibly mean you can see a lot of christian elemnts in it. The
          text just seems to be gibberish.
        </P>
        <P>Image 1: Mix between the pope and Bernie Sanders?</P>
        <P>Image 2: An orthodox priest</P>
        <P>Image 3: A poor person or maybe a monk?</P>
        <P>Image 4: An angel</P>
        <P>
          Image 5: Maybe the white gown or the beard are supposed to look
          religous
        </P>
        <P>Image 6: Ugly Mary?</P>
        <br />
        <Heading as="h3" fontSize={15}>
        ...
        <P>
          This is just me having some more fun. I was actually surprised how
          well the faces turned out. As you will see in the next images human
          anatomy is not always easy.
        </P>
        <br />
        <Heading as="h3" fontSize={15}>
        ...
        ></PostImage>
        <P>
          The most egregious flaw must be the hands. They resemble more of feet
          than hands. There are serveral more issues like the piano keys, the
          legs and it seems like the &quot;nostalgic&quot; keyword was
          forgotten.
        </P>
        <br />
        <Heading as="h3" fontSize={15}>
        ...
        ></PostImage>
        <P>
          My first attempt in order to get a better result was to input words
          that are more context related. This image is already a lot closer to
          what I imagined and although you can recognize the hands they look
          very wrong. The next image has been generated using the image to image
          method and with only one input word &quot;hands&quot;.
        </P>
        <br />
        <Heading as="h3" fontSize={15}>
          Input: hands
        ...
        ></PostImage>
        <P>
          The idea was to only focus on one thing. Now the right hand has
          something like a thumb and the left hand has 3.5 fingers instead of 3.
          But to be honest the left hand looks more wrong in this image.
        </P>
        <br />
        <Heading as="h3" fontSize={15}>
          Input: pianist, piano, hand, looking down, detailed, detailed skin,
          detailed face, relaxed, light, shadow, photo, symmetrical ears and
          face shape, symmetrical circular eyes reflecting the environment,
          natural color
        </Heading>
        <PostImage
        ...
        <P>
          ...
          think it does not help that we are very familiar with human anatomy
          and its depiction so that any oddness will immediately stand out.
        </P>
        <P>
          Next I tried to generate something simpler as a comparison. Take a
          look at the following four images of just a hand and people waving
          respectively. I am not going to include the input for each picture but
          I have used this
          <Link
