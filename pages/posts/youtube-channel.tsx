    ...
    <Layout title="">
      <Container4k>
        ...
        <P>
          ...
          <br />
          If there is enough interest I&apos;d also like to post a video about
          my desktop setup or &quot;desktop rice&quot; at some point.
        </P>
        <br />
        ...
        <List>
          <ListItem>
            <Link
              href="https://www.youtube.com/watch?v=LVJjFvGkAzs"
              target="_blank"
            >
              Terminal Timetable: Public transport timetable in Terminal using
              Python
            </Link>
            <Box
              position="relative"
              width="100%"
              height={{ base: '200px', md: '400px', lg: '700px' }}
              mt={2}
              mb={4}
            >
              <Box
          ...
          <ListItem>
            <Link
              href="https://www.youtube.com/watch?v=djLVyRi5tts"
              target="_blank"
            >
            ...
            >
              <Box
                ...
                width="100%"
                height="100%"
                src="https://www.youtube.com/embed/djLVyRi5tts?si=-Axk8EGoZIyulcfO"
                title="Ransomware Simulation - How do they work?"
                frameBorder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
                position="absolute"
