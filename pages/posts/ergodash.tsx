import { Badge, SimpleGrid, Link } from "@chakra-ui/react";
...
const ErgoDash = () => {
  return (
    <Layout title="">
      <Container4k>
        <Title>
          ErgoDash Keyboard (work in progress)&nbsp;
          <Badge>December 2022</Badge>
        </Title>
        <P>
          <Link
            href="https://github.com/omkbd/ErgoDash"
            target="_blank"
            _focus={{ boxShadow: "none" }}
          >
            ErgoDash{" "}
          </Link>
          is an open source split keyboard. I was introduced to it by a generous
          friend when he gave me two ErgoDash PCBs and let me try out the one he
          built. No need to say I was amazed. I will not go into details about
          the build guide but you can check out my progress in the picture
          below.
        </P>
        <SimpleGrid columns={[1, 1, 2]} gap={6} my={4}>
          ...
          >
            I 3D printed all the case parts like the switch plate and bottom
            plate. You can find various models on Thingiverse.
          </GridItem>
          <GridItem
          ...
          >
            Here you can see the diodes and backlight LEDs soldered on the
            backside of the PCB.
          </GridItem>
          <GridItem
          ...
          >
            It was actually not that easy to get 6mm spacers (fast). They are
            used to create the space between switch and bottom plate.
          </GridItem>
        </SimpleGrid>
        <P>
          The next step is to get the firmware working for a custom key mapping
          and backlight. As you can see I also still need to get a nice set of
          keycaps.
          <br /> <br />
          To be continued...
        </P>
