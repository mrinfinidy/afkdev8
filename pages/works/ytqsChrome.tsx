...
const Work = () => {
  return (
    <Layout title="">
      <Container4k>
        <Title>
          Video Quick Search Chrome (for YouTube)&nbsp;
          <Badge>2020-present</Badge>
        </Title>
        <P>
          A Chrome extension that lets you search highlighted text directly on
          YouTube by right clicking it and selecting &apos;Search on
          YouTube&apos;.
        </P>
        <WorkImage
          src="/images/works/youtubeQuickSearchChrome/youtubeQuickSearchChrome.png"
