...
const Work = () => {
  return (
    <Layout title="">
      <Container4k>
        <Title>
          YouTube Autofocus&nbsp;<Badge>2021-present</Badge>
        </Title>
        <P>
          A Firefox extension that automatically focuses on the search bar when
          YouTube homepage is loaded.
        </P>
        <List ml={4} my={4}>
          <ListItem>
            <Meta>Website</Meta>
          ...
          <ListItem>
            <Meta>Source</Meta>
            <Link
              href="https://github.com/mrinfinidy/autofocusYT"
              target="_blank"
              _focus={{ boxShadow: "none" }}
            >
